...
class ProgressViewDownload @JvmOverloads constructor(
    context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0
) : InfiniteAnimateView(context, attrs, defStyleAttr) {

    private val defaultBgColor: Int = ContextCompat.getColor(context, R.color.green_light)
    private val defaultBgStrokeColor: Int = ContextCompat.getColor(context, R.color.green_light)
